...
> SOUP as a certain risk level. Unless you're developing software that shoots radiation at patients, it's
...
> idea is to only have one "global" SOUP list for your device even though the code may actually live
...
> e.g. "runs on linux". So prefer to keep the requirements simple, in a way in which you would communicate it
> to colleages on your development team when answering the question "why did we import this library?".
...
|----|-----------------|--------------|----------------------|---------|--------------------------------------------------|------------------|------------|----------------------------|---------------------------------------------------------------------------|
| 1  | Mobile App      | react-native | JavaScript           | 0.61    | [Link](https://facebook.github.io/react-native/) | 23.10.2020       | Low        | * Runs JS on Android / iOS | Commonly used, maintained by large organisation, sufficient test coverage |
